...
class PID:
    ...
    def calc_delayed_acc(self):
        ...
        # self.prev_acc = (self.current_vel - self.prev_vel)
 
    def calc_vel(self):
        self.current_vel += (self.current_acc) * 100.00
        # self.current_vel += (self.current_acc)
 
    def calc_pos(self):
        self.current_pos += (self.current_vel * 100.00) + (0.5 * self.current_acc * (100.00**2))
        # self.current_pos += (self.current_vel) + (0.5 * self.current_acc)
    ...
    def simulate(self, idx, set_points):
        ...
        if (idx < len(set_points)):
            ...
            # self.sp_curr_vel = self.sp_curr_vel + (self.sp_prev_acc)
            ...
            if (idx + 1 < len(set_points)):
                ...
                # self.sp_next_acc = ((set_points[idx+1] - self.sp_curr_pos) - self.sp_curr_vel)
        ...
        self.pos_array.append(self.current_pos)
    ...
    def update(self): #calculate new acceleration value
        ...
        print '############# PID update #############'   
        print 'set point acc', self.sp_curr_acc
        print 'current acc', self.current_acc
